...
export default function PortfolioSection() {
  ...
  const categories = ['All', 'Enterprise', 'Business', 'SaaS', 'Productivity', 'E-Commerce', 'CMS', 'Real-time'];
  ...
  // Get the first 9 projects (Business & Enterprise Group)
  const pageProjects = portfolioData.projects.slice(0, 9);
