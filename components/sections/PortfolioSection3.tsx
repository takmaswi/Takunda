...
export default function PortfolioSection3() {
    ...
    const categories = ['All', '3D/WebGL', 'Portfolio', 'Media', 'Mobile', 'Education', 'Health/Education', 'Content', 'Utility'];
    ...
    // Get projects 18-27 (Creative, Media & Lifestyle Group)
    const pageProjects = portfolioData.projects.slice(18, 27);
        ...
        >
            <div className="w-full flex flex-col items-center">
                ...
                <p className="text-center text-gray-300 text-xs mb-8 font-inter tracking-wide">
                    Final collection of featured works
                </p>
